...
2. 주제 : 자격증 사이트<br>
3. 목적 :  O1Y3 사이트는 고객이 자격증 원서접수, 시험 일정표 확인, 자격증 증명서 발급 등의 다양한 자격증 관련 정보 확인을 주목적으로 진행된 자격증 사이트 프로젝트 입니다.<br>
4. 주요 기능 : 로그인, 회원가입<br>
- 역할 분담 : <br>
...
-단, 필수 약관 내용에 동의한 경우에만, 본인인증 페이지로 이동된다(조건).
...
<설명><br>
-회원가입 완료 후, 로그인 버튼 선택하는 경우에는 로그인창으로,  <br>
또는 메인홈으로 버튼 선택하는 경우에는 메인창으로 이동한다. <br>
...
<설명> <br>
-만 14세 이상인 경우만, 회원가입이 가능하다(약관동의 페이지로 이동된다). <br>
...
<설명> <br>
-value를 활용하여, 비밀번호 입력 내용과 비밀번호 확인 입력 내용이 서로 일치하지 않는 경우, <br>
if문을 활용하여, 오류 메세지가 출력되면서, 동일한 내용으로 비밀번호 재입력을 권장한다. <br>
...
- 요구사항 정의서 분석 후, 이를 바탕으로 워크 플로우를 구체적으로 작성하고 활용하여, <br>
  프로젝트를 체계적으로 계획하고 효율적으로 진행할 수 있음.
</b>
